...
# An example that shows how our DAG can become more complex
# if create_metrics from figure_11 is made into multiple tasks
# The result is a larger number of repeated tasks.
dag = DAG(
    dag_id="figure_12",
